...
def parse_args():
    ...
    parser.add_argument(
        '--pose2d',
        type=str,
        default='configs/rtmpose/hand5/rtmpose-m_8xb256-210e_hand5-256x256.py',
        help='Pretrained 2D pose estimation algorithm. It\'s the path to the '
        'config file or the model name defined in metafile.')
    parser.add_argument(
        '--pose2d-weights',
        type=str,
        default='weights/rtmpose-m_simcc-hand5_pt-aic-coco_210e-256x256-74fb594_20230320.pth',
    ...
    parser.add_argument(
        '--vis-out-dir',
        type=str,
        default='work_dirs/vis_data/pose',
